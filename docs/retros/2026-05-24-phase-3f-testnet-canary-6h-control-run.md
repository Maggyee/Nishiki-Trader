# Phase 3f testnet canary session - 2026-05-24 6 h control run

- **Date (UTC)**: 2026-05-24T00:54:23Z - 2026-05-24T06:54:28Z
- **Operator**: nishiki
...
This run adds the first clean 6 h block on 2026-05-24 UTC. It advances the
strict current qualified-day streak to `4/14`.

## 2. Run Identity

- bundle: `data/testnet/20260524-005423Z-24c8c34d/`
- run_id: `20260524-005423Z-24c8c34d`
- git_commit at launch: `8e91489880f518b505bbde61d424da9b0458f6bf`
- git_dirty: `false`
- manifest_sha256:
  `114721398f2f074e7293a96bcfc665dd6ba0e189d391a0353d96feafc2274b87`
- started_at: `2026-05-24T00:54:23.036Z`
- finished_at: `2026-05-24T06:54:28.413Z`
- elapsed_seconds: `21605.376894` (max_run_seconds = `21600`)
...
| daily_pnl USDT (final telemetry) | `76774.8459` |
| account_total_usdt (final telemetry) | `86774.8459` |
...
- first heartbeat: `2026-05-24T00:54:23.080Z`
- last heartbeat: `2026-05-24T06:53:53.964Z`
- count: `719` rows in `logs/heartbeat.jsonl`
- max heartbeat gap: `30.176` s
...
| event | ts |
|---|---|
| `credentials_loaded` | `2026-05-24T00:54:23.036Z` |
| `node_built` | `2026-05-24T00:54:23.079Z` |
| `strategies_registered` (strategies = `1`, actors = `0`) | `2026-05-24T00:54:23.080Z` |
| `node_run_invoked` | `2026-05-24T00:54:23.082Z` |
| `sidecar_write` (success=true) | `2026-05-24T06:54:28.404Z` |
| `shutdown` (stop_reason=`max_duration`) | `2026-05-24T06:54:28.413Z` |
...
- final state before watchdog shutdown:
  ...
  `alert_path=null`, `last_heartbeat_at=2026-05-24T06:53:53.964Z`
...
- Net realized PnL on closed position: `+0.16557 USDT`
- Final position side: `FLAT`

Entry:

- `BUY MARKET 0.001 BTCUSDT.BINANCE @ 76847.49 USDT`
- client_order_id `O-20260524-005700-001-000-1`
- venue_order_id `6670493`
- trade_id `2101351`
- fill ts_event `2026-05-24T00:57:00.452000Z`
- signal tag
  `freqai_linear_v1:linear-mom-train20240105:wall_clock_replay:BTCUSDT:BINANCE:1779584212282893428:buy:f5a25702f48a`

Scheduled close:

- `SELL MARKET 0.001 BTCUSDT.BINANCE @ 77013.06 USDT`
- client_order_id `O-20260524-065423-001-000-2`
- venue_order_id `6742894`
- trade_id `2120859`
- fill ts_event `2026-05-24T06:54:23.169999872Z`

Position close:

- sidecar position_id `position-a550663c8eb3e8fa3b906b7e`
- `avg_px_open=76847.49` / `avg_px_close=77013.06`
- `realized_pnl=+0.16557 USDT`
- `realized_return=0.00215` (+0.215%)
- final `side=FLAT`, `quantity=0.0`, `unrealized_pnl=0.0`
- final sidecar account snapshot includes `USDT=86774.83823`.
...
- first_ts_event:
  `1779584212282893428` (`2026-05-24T00:56:52.282893Z`)
- last_ts_event:
  `1779605767282893428` (`2026-05-24T06:56:07.282893Z`)
- interval_seconds: `45`
- side: `buy`
...
- lineage `ts_event` range:
  `2026-05-24T00:56:52.282893428Z` -
  `2026-05-24T06:53:52.282893428Z`
...
data/testnet/20260524-005423Z-24c8c34d` returned:
...
Clean aggregate across the eight clean 6 h canary bundles now reports:

- `clean_run_count: 8/8`
- `clean_elapsed_hours: 48.01`
- `orders=16 / fills=16 / positions=8 / heartbeats=5754 / alerts=0`
- `clean_realized_pnl=-0.82602 USDT`
