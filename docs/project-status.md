...
- **Current objective**: The v27 fixture accepts 19/19 ordered operations and [historical profiles pass 22 v27 regressions](progress/portfolio-installed-v27-joint-regression-2026-09-25.md). The [original-byte handoff](progress/portfolio-v27-joint-contract-handoff-2026-09-25.md) confirms the separate real draft's 17 GETs / 468 documented weight and 21 preparations. A [prospective first-operation window barrier](progress/portfolio-prospective-joint-window-2026-09-26.md) now checks a held guard's history/horizon and consumes a local ledger preparation, but no root-owned kernel/source observer is installed; synthetic observations do not qualify egress. The [authority/capacity review](progress/portfolio-post-v27-authority-capacity-review-2026-09-25.md) still blocks real collection before its first request: four fixture assets reconcile, while the historical three-route pilot leaves 496 assets outside, two unpriced and 65 over top-book capacity. Next implement the actual authenticated kernel/source/egress observer and fresh provider bounds before a separately gated testnet collection. Full real account coverage, stream fences, provider clocks/usage, qualified equity and trading remain blocked.
