...
- **Status file**: Active
- **Last updated**: 2026-08-13 (Protocol v18 Cboe OHLC histories qualified; development PnL unopened)
...
- `docs/progress/phase-2-research-protocol-v18.md` — OHLC recovery of the
  unchanged v17 rules; provider qualified, development PnL unopened.
...
14. Preserve v17's schema mismatch. Do not rewrite its locked columns, retry VXEEM under that identity, or treat the observed header as a signal input. Keep v18 snapshots immutable and open 2020-2022 development only under the frozen five-observation rules.
...
18. Run Protocol v18 2020-2022 development from the qualified snapshots without retuning. Confirmation stays sealed until a candidate passes every frozen gate.
