...
- **Status file**: Active
- **Last updated**: 2026-08-17 (Protocol v47 BTC Realized Volatility relief closed; Protocol v48 Binance Perpetual Basis relief passed confirmation and advanced to paper_shadow)
...
- `docs/progress/phase-2-research-protocol-v42.md` — Cboe volatility term structure & horizon relief expansion
  (VIX9D, VIX3M, VIX6M); VIX6M passed 2023-2025 confirmation, held at `paper_shadow`, Day 1 qualified (2/7 runs, 17 signals), weekday 03:45 UTC crontab installed.
...
- `docs/progress/phase-2-research-protocol-v46.md` — Binance Perpetual Premium Index standard basis relief
  (BTC Premium 5-day delta < 0.0 standard relief); passed 2023-2025 confirmation (+13.68 USDT base, 2/3 positive years, 21/36 positive months, leave-best +7.22 USDT), held at `paper_shadow`, Day 1 qualified (1/7 runs, 99 signals), daily 04:00 UTC crontab installed.
