...
- **Current objective**: The v27 fixture accepts 19/19 ordered operations and [historical profiles pass 22 v27 regressions](progress/portfolio-installed-v27-joint-regression-2026-09-25.md). The [original-byte handoff](progress/portfolio-v27-joint-contract-handoff-2026-09-25.md) confirms the separate real draft's 17 GETs / 468 documented weight and 21 preparations. The [prospective first-operation barrier](progress/portfolio-prospective-joint-window-2026-09-26.md) checks a held guard's history/horizon and consumes a local ledger preparation. A separate [read-only kernel observer prototype](progress/portfolio-joint-kernel-observer-2026-09-26.md) checks two nft tables, timers and the netdev device in a disposable network namespace; its caller-selected digest and instantaneous readings cannot authenticate an installed guard or qualify egress. The [authority/capacity review](progress/portfolio-post-v27-authority-capacity-review-2026-09-25.md) still blocks real collection before its first request: four fixture assets reconcile, while the historical three-route pilot leaves 496 assets outside, two unpriced and 65 over top-book capacity. Next establish protected installation/activation custody, complete host/container/proxy/source coverage and fresh provider bounds before a separately gated testnet collection. Full real account coverage, stream fences, provider clocks/usage, qualified equity and trading remain blocked.
