...
- **Current objective**: The v27 fixture accepts 19/19 ordered operations and [historical profiles pass 22 v27 regressions](progress/portfolio-installed-v27-joint-regression-2026-09-25.md). The [original-byte handoff](progress/portfolio-v27-joint-contract-handoff-2026-09-25.md) confirms the separate real draft's 17 GETs / 468 documented weight and 21 preparations. The [prospective first-operation barrier](progress/portfolio-prospective-joint-window-2026-09-26.md) checks a held guard's history/horizon and consumes a local ledger preparation. A [read-only kernel observer](progress/portfolio-joint-kernel-observer-2026-09-26.md) now requires actual IPv4/IPv6 drop rules even if its static digest is self-pinned, and a [held-selection adapter](progress/portfolio-joint-window-held-selection-2026-09-26.md) stages fixed root-owned policy/code selection under the existing installation verifier. Neither is installed on the host; the host has no joint nft table, activation journal or continuous all-caller/source proof. The [authority/capacity review](progress/portfolio-post-v27-authority-capacity-review-2026-09-25.md) still blocks real collection before its first request: four fixture assets reconcile, while the historical three-route pilot leaves 496 assets outside, two unpriced and 65 over top-book capacity. Next establish protected one-shot activation custody, reviewed collector-only dispatch rules, complete host/container/proxy/source coverage and fresh provider bounds before a separately gated testnet collection. Full real account coverage, stream fences, provider clocks/usage, qualified equity and trading remain blocked.
