...
| Research Protocol v16 Treasury-direct rate mechanisms | `docs/progress/phase-2-research-protocol-v16.md`, `docs/progress/phase-2-research-protocol-v16.json`, `docs/progress/phase-2-research-v16-data-sources.json`, `docs/progress/phase-2-research-v16-development-results.json`, `docs/progress/phase-2-research-v16-confirmation.json`, `docs/retros/2026-08-12-research-v16-treasury-rates-development.md`, `apps/ops/research_protocol_v16.py`, `apps/ops/research_v16_snapshot.py`, `apps/ops/research_v16_review.py`, `apps/ops/research_v16_confirmation.py`, `apps/ops/research_v16_confirmation_snapshot.py`, `apps/strategies_freqtrade/research/treasury_rate_signals.py`, `apps/strategies_freqtrade/research/treasury_rate_confirmation_signals.py`; development is committed, only Treasury-yield volatility relief may open the pre-registered 2023-2025 confirmation, and the future blind remains sealed |
