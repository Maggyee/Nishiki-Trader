...
| Research Protocol v10/v11 crypto-native fundamentals | `docs/progress/phase-2-research-protocol-v10.md`, `docs/progress/phase-2-research-protocol-v10.json`, `docs/progress/phase-2-research-v10-data-sources.json`, `docs/progress/phase-2-research-protocol-v11.md`, `docs/progress/phase-2-research-protocol-v11.json`, `apps/ops/research_protocol_v10.py`, `apps/ops/research_v10_snapshot.py`, `apps/ops/research_protocol_v11.py`, `apps/strategies_freqtrade/research/native_fundamental_signals.py`; v10 closed because Community API rows lacked status-time, while v11 preserves the three rules and pre-registers finalized-ledger reconstruction at a D+2 decision lag before value/PnL access |
