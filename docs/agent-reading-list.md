...
| Research Protocol v12 stablecoin forward data | `docs/progress/phase-2-research-protocol-v12.md`, `docs/progress/phase-2-research-protocol-v12.json`, `apps/ops/research_protocol_v12.py`, `apps/ops/research_v12_forward_daily.py`, `infra/research-v12/README.md`; the unchanged USDT+USDC 30-observation rule is isolated at `forward_data_candidate`, D+2 observations before 2026-08-12 are bootstrap-only, and recurring host scheduling requires explicit operator approval |
