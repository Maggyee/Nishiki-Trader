...
| Independent alt portfolio study | `docs/progress/phase-2-independent-alt-portfolio-study.md`, `apps/strategies_freqtrade/research/alt_portfolio_signals.py`, `apps/ops/daily_archive_audit.py`, `apps/ops/catalog_audit.py`, `apps/ops/multi_asset_review.py` |
