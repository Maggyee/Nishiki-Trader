...
| Flow and funding-positioning study | `docs/progress/phase-2-flow-positioning-study.md`, `apps/strategies_freqtrade/research/flow_positioning_signals.py`, `apps/ops/backfill_funding.py`, `apps/ops/feature_audit.py`, `apps/ops/multi_asset_review.py` |
