...
| Research Protocol v8 GVZ independent confirmation | `docs/progress/phase-2-research-protocol-v8.md`, `docs/progress/phase-2-research-protocol-v8.json`, `docs/progress/phase-2-research-v8-data-sources.json`, `apps/ops/research_protocol_v8.py`; one unchanged GVZ identity is frozen for 2023-2025 confirmation under market-session-aware continuity, while the 2026-09..2027-01 future blind remains sealed |
