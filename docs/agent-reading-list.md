...
| Research Protocol v2 independent mechanisms | `docs/progress/phase-2-research-protocol-v2.md`, `docs/progress/phase-2-research-protocol-v2.json`, `docs/progress/phase-2-research-v2-data-sources.json`, `docs/retros/2026-07-11-research-v2-provider-qualification.md`, `apps/ops/research_protocol_v2.py`, `apps/ops/research_v2_snapshot.py`, `apps/strategies_freqtrade/research/independent_mechanism_signals.py` |
