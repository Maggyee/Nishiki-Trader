...
| Multi-asset rotation study | `docs/progress/phase-2-multi-asset-rotation-study.md`, `apps/strategies_freqtrade/research/multi_asset_rotation_signals.py`, `apps/ops/multi_asset_review.py`, `apps/ops/strategy_tournament.py` |
