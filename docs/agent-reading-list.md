...
| Research Protocol v14 BTC valuation mechanisms | `docs/progress/phase-2-research-protocol-v14.md`, `docs/progress/phase-2-research-protocol-v14.json`, `apps/ops/research_protocol_v14.py`, `apps/ops/research_v14_snapshot.py`, `apps/strategies_freqtrade/research/valuation_mechanism_signals.py`; realized-cap expansion, NVT compression, and SOPR capitulation are pre-registered before metric-body access, with v12-v13 and all trading paths unchanged |
