...
| Research Protocol v7 Cboe cross-asset volatility batch | `docs/progress/phase-2-research-protocol-v7.md`, `docs/progress/phase-2-research-protocol-v7.json`, `docs/progress/phase-2-research-v7-data-sources.json`, `docs/progress/phase-2-research-v7-replication-results.json`, `docs/retros/2026-08-11-research-v7-replication-review.md`, `apps/ops/research_protocol_v7.py`, `apps/ops/research_v7_snapshot.py`, `apps/ops/research_v7_review.py`, `apps/strategies_freqtrade/research/cross_asset_volatility_signals.py`; replication is complete, all three candidates are rejected, and the future blind must remain sealed |
