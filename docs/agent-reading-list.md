...
| Active diverse-strategy tournament | `docs/progress/phase-2-diverse-strategy-tournament.md`, `apps/strategies_freqtrade/research/diverse_strategy_signals.py`, `apps/ops/strategy_tournament.py` |
