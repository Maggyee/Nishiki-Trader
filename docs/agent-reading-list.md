...
| Research Protocol v5 Binance-native mechanisms | `docs/progress/phase-2-research-protocol-v5.md`, `docs/progress/phase-2-research-protocol-v5.json`, `docs/progress/phase-2-research-v5-data-sources.json`, `docs/progress/phase-2-research-v5-candidate-fingerprints.json`, `apps/ops/research_protocol_v5.py`, `apps/ops/research_v5_snapshot.py`, `apps/ops/research_v5_daily.py`, `apps/ops/research_v5_review.py`, `apps/strategies_freqtrade/research/binance_mechanism_signals.py`, `apps/ops/multi_asset_review.py` |
| Research Protocol v6 Binance-native availability discovery | `docs/progress/phase-2-research-protocol-v6.md`, `docs/progress/phase-2-research-v6-binance-availability.json`; discovery is metadata-only until a separate candidate identity, parameters, windows, and gates are pre-registered |
