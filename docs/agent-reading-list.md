...
| Research Protocol v13 BTC network mechanisms | `docs/progress/phase-2-research-protocol-v13.md`, `docs/progress/phase-2-research-protocol-v13.json`, `apps/ops/research_protocol_v13.py`, `apps/ops/research_v13_snapshot.py`, `apps/strategies_freqtrade/research/network_mechanism_signals.py`; active-address expansion, transfer-count expansion, and MVRV-below-one are pre-registered before time-series body access, with v12 and all trading paths unchanged |
