...
| Research Protocol v15 U.S. rate mechanisms | `docs/progress/phase-2-research-protocol-v15.md`, `docs/progress/phase-2-research-protocol-v15.json`, `apps/ops/research_protocol_v15.py`, `apps/ops/research_v15_snapshot.py`, `apps/strategies_freqtrade/research/rate_mechanism_signals.py`; real-yield relief, yield-curve steepening, and nominal-rate-volatility relief are pre-registered before the credential-free FRED body is opened |
