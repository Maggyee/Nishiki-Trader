...
| Active locked pullback-regime candidate | `docs/progress/phase-2-pullback-regime-hypothesis.md`, `apps/strategies_freqtrade/research/pullback_regime_signals.py`, `apps/ops/alpha_review.py` |
