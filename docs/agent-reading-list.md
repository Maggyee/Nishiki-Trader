...
| Research Protocol v10 crypto-native fundamentals | `docs/progress/phase-2-research-protocol-v10.md`, `docs/progress/phase-2-research-protocol-v10.json`, `apps/ops/research_protocol_v10.py`, `apps/ops/research_v10_snapshot.py`; three Coin Metrics routes and candidate identities are pre-registered before any time-series body access, provider qualification is pending, and all trading paths remain unchanged |
