...
| Research Protocol v16 Treasury-direct rate mechanisms | `docs/progress/phase-2-research-protocol-v16.md`, `docs/progress/phase-2-research-protocol-v16.json`, `apps/ops/research_protocol_v16.py`, `apps/ops/research_v16_snapshot.py`, `apps/strategies_freqtrade/research/treasury_rate_signals.py`; unchanged v15 economic rules use eight separately fingerprinted official annual Treasury CSV routes, all body-free HEAD qualified before values |
