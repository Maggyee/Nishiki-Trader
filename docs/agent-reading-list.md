...
| Research Protocol v3 macro/native mechanisms | `docs/progress/phase-2-research-protocol-v3.md`, `docs/progress/phase-2-research-protocol-v3.json`, `docs/progress/phase-2-research-v3-data-sources.json`, `apps/ops/research_protocol_v3.py`, `apps/strategies_freqtrade/research/macro_native_mechanism_signals.py` |
