...
from apps.ops.research_protocol_v31 import (
    DEFAULT_PROTOCOL,
    load_and_validate,
    validate_protocol,
)
...
def test_protocol_v31_is_frozen_and_valid() -> None:
...
def test_protocol_v31_rejects_direction_drift() -> None:
...
def test_protocol_v31_rejects_opened_history() -> None:
    payload = json.loads(DEFAULT_PROTOCOL.read_text())
