...
from apps.ops.research_protocol_v35 import DEFAULT_PROTOCOL, load_and_validate, validate_protocol


def test_v35_pre_registration_contract_is_valid() -> None:
...
def test_v35_pre_registration_rejects_drift(path: tuple, value: object) -> None:
