...
from apps.ops.research_v18_confirmation_factor import _audit_confirmation_rows
...
def test_v18_confirmation_factor_audit_accepts_complete_grid() -> None:
...
def test_v18_confirmation_factor_audit_rejects_large_gap() -> None:
    omitted = {
        date(2024, 1, 1),
        date(2024, 1, 2),
        date(2024, 1, 3),
