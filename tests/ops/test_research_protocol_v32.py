...
from apps.ops.research_protocol_v32 import (
    DEFAULT_PROTOCOL,
    load_and_validate,
    validate_protocol,
)
...
def test_protocol_v32_is_frozen_and_valid() -> None:
...
def test_protocol_v32_rejects_direction_drift() -> None:
...
def test_protocol_v32_rejects_opened_history() -> None:
    payload = json.loads(DEFAULT_PROTOCOL.read_text())
