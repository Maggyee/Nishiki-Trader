...
from apps.ops.research_protocol_v15 import DEFAULT_PROTOCOL, validate_protocol
...
def test_v15_contract_is_valid() -> None:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("boundaries_effect", "reopens_v14"), True),
    ],
)
def test_v15_rejects_drift(path: tuple, value: object) -> None:
