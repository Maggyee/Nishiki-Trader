...
from apps.ops.research_v25_confirmation import DEFAULT_CONTRACT, validate_contract
...
def test_v25_confirmation_contract_is_valid() -> None:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("data_access_disclosure", "new_network_request_required"), True),
    ],
)
def test_v25_confirmation_rejects_drift(path: tuple, value: object) -> None:
