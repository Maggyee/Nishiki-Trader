...
def test_protocol_v41_is_valid() -> None:
...
def test_protocol_v41_detects_candidate_drift() -> None:
    payload = json.loads(DEFAULT_PROTOCOL_PATH.read_text())
    payload["candidates"]["eth_btc_rs_expansion"]["parameters"]["direction"] = "negative"
