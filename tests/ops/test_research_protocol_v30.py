...
from apps.ops.research_protocol_v30 import (
    DEFAULT_PROTOCOL,
    load_and_validate,
    validate_protocol,
)
...
def test_protocol_v30_is_frozen_and_valid() -> None:
...
def test_protocol_v30_rejects_direction_drift() -> None:
...
def test_protocol_v30_rejects_opened_history() -> None:
    payload = json.loads(DEFAULT_PROTOCOL.read_text())
