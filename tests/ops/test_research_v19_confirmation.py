...
from apps.ops.research_v19_confirmation import DEFAULT_CONTRACT, validate_contract
...
def test_v19_confirmation_contract_is_valid() -> None:
...
def test_v19_confirmation_rejects_drift(path: tuple, value: object) -> None:
