...
from apps.strategies_freqtrade.research.options_oi_signals import (
    generate_options_oi_expansion_signals,
)
...
def test_options_oi_expansion_rules_emit_buy_then_flat(candidate: str) -> None:
...
def test_options_oi_expansion_rule_rejects_lag_drift() -> None:
    ...
    with pytest.raises(ValueError, match="two-day publication lag"):
        generate_options_oi_expansion_signals(
            frame,
            candidate="open_interest_expansion",
            start_date="2019-11-01",
        )
