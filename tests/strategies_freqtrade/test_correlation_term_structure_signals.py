...
from apps.strategies_freqtrade.research.correlation_term_structure_signals import (
    audit_factor_frame,
    generate_correlation_term_structure_signals,
)
...
def test_v33_generators_emit_only_state_changes_and_long_flat(candidate: str) -> None:
...
def test_v33_audit_factor_frame_rejects_lookahead() -> None:
