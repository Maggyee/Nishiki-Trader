...
from apps.strategies_freqtrade.research.commodity_sector_duration_vol_signals import (
    generate_commodity_sector_duration_vol_relief_signals,
)
...
@pytest.mark.parametrize(
    "candidate",
    ["silver_vol_relief", "energy_sector_vol_relief", "long_treasury_etf_vol_relief"],
)
def test_v31_vol_rules_emit_buy_then_flat(candidate: str) -> None:
...
def test_v31_vol_rule_rejects_lag_drift() -> None:
