...
from apps.strategies_freqtrade.research.single_name_vol_signals import (
    generate_single_name_vol_relief_signals,
)
...
@pytest.mark.parametrize(
    "candidate",
    ["apple_vol_relief", "amazon_vol_relief", "google_vol_relief"],
)
def test_single_name_vol_rules_emit_buy_then_flat(candidate: str) -> None:
...
def test_single_name_vol_rule_rejects_lag_drift() -> None:
