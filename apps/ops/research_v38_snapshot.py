"""Fetch and audit Cboe historical CSVs for Protocol v38 (VPD, PPUT, CLL)."""
...
from apps.ops.research_protocol_v38 import load_and_validate

SCHEMA_VERSION = "research.v38.snapshot.v1"
AUDIT_SCHEMA_VERSION = "research.v38.provider_qualification.v1"
RAW_ROOT = Path("data/research-v38/raw")
FACTORS_ROOT = Path("data/research-v38/factors")
QUALIFICATION_PATH = Path("docs/progress/phase-2-research-v38-provider-qualification.json")
DATA_SOURCES_PATH = Path("docs/progress/phase-2-research-v38-data-sources.json")

URLS = {
    "vpd": "https://cdn.cboe.com/api/global/us_indices/daily_prices/VPD_History.csv",
...
def _fetch(url: str) -> bytes:
    request = urllib.request.Request(
        url,
        headers={"User-Agent": "Nishiki-Trader/research-v38 (+https://github.com/Maggyee/Nishiki-Trader)"},
    )
...
def collect_and_qualify_all(
    ...
    qualification = {
        "schema_version": "research.provider_qualification.v38.v1",
        "protocol": "docs/progress/phase-2-research-protocol-v38.json",
