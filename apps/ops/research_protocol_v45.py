"""Contract definitions and validation for Phase 2 Alpha Research Protocol v45."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v45.json")
SCHEMA_VERSION = "research.protocol.v45.v1"
