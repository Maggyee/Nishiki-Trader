"""Contract for Phase 2 Alpha Research Protocol v51 (BTC funding-rate positioning states).

Provider-corrected recovery of Protocol v50, following the v17 → v18
precedent: v50 froze a development fetch range starting 2019-12, but the
Binance Vision monthly ``fundingRate`` archive for BTCUSDT starts at 2020-01,
so v50 closed at ``blocked_provider_qualification`` on its first GET (HTTP
404) with zero values opened. v51 registers the UNCHANGED three rules under
new identities with a corrected data contract: development months
2020-01..2022-12, evaluation windows unchanged, and the frozen fail-safe
(fewer than 6 settlements in the trailing 72h forces flat) covering the first
three days of January 2020. No thresholds, rules, windows, or gates changed.
...
- the staged fetch boundary: development months 2020-01..2022-12 may be
...
SCHEMA_VERSION = "research.protocol.v51.v1"
...
FUNDING_SOURCE = {
    ...
    "symbol": SYMBOL,
    "development_months": ["2020-01", "2022-12"],
    "confirmation_months": ["2023-01", "2025-12"],
    "archive_dir": "data/research-v51/funding",
...
CLOSES_SOURCE = {
    ...
    "start_month": "2019-12",
    "end_month": "2025-12",
    "csv_path": "data/research-v51/closes/btcusdt-1d-closes-2019-12-2025-12.csv",
}
...
DATA_QUALITY_GATES = {
    ...
    "min_development_settlements": 3200,
    "min_confirmation_settlements": 3200,
    "quality_scope_start": "2020-01-01",
}
