"""Open the frozen v33 COR1Y holdout and export its point-in-time factor."""
...
from apps.ops.research_v33_snapshot import parse_and_audit_csv, verify_snapshot

SCHEMA_VERSION = "research.v33.confirmation_data.v1"
...
def request_plan() -> dict[str, Any]:
    ...
    return {
        "schema_version": "research.v33.confirmation_factor_plan.v1",
...
def write_confirmation_factor(
    ...
    *,
    ...
    if warmup_rows < 5:
        raise ValueError("Protocol v33 confirmation warmup is insufficient")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/research-v33/confirmation/factors/cor1y.csv"),
    )
