"""Fetch and audit Cboe historical CSVs for Protocol v37 (BXN, BXY, BXR)."""
...
from apps.ops.research_protocol_v37 import load_and_validate

SCHEMA_VERSION = "research.v37.snapshot.v1"
AUDIT_SCHEMA_VERSION = "research.v37.provider_qualification.v1"
RAW_ROOT = Path("data/research-v37/raw")
FACTORS_ROOT = Path("data/research-v37/factors")
QUALIFICATION_PATH = Path("docs/progress/phase-2-research-v37-provider-qualification.json")
DATA_SOURCES_PATH = Path("docs/progress/phase-2-research-v37-data-sources.json")

URLS = {
    "bxn": "https://cdn.cboe.com/api/global/us_indices/daily_prices/BXN_History.csv",
    "bxy": "https://cdn.cboe.com/api/global/us_indices/daily_prices/BXY_History.csv",
    "bxr": "https://cdn.cboe.com/api/global/us_indices/daily_prices/BXR_History.csv",
}
...
def _fetch(url: str) -> bytes:
    request = urllib.request.Request(
        url,
        headers={"User-Agent": "Nishiki-Trader/research-v37 (+https://github.com/Maggyee/Nishiki-Trader)"},
    )
...
def collect_and_qualify_all(
    ...
    qualification = {
        "schema_version": "research.provider_qualification.v37.v1",
        "protocol": "docs/progress/phase-2-research-protocol-v37.json",
