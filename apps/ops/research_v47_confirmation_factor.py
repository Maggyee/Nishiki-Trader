"""Generate confirmation factor CSV for Protocol v47 candidate."""
...
from apps.ops.research_v47_snapshot import (
    QUALIFICATION_PATH,
    compute_factors,
    write_factor_csv,
)
...
def generate_confirmation_factor() -> Path:
    ...
    spot_rows = envelope["spot_rows"]

    factors = compute_factors(spot_rows)
    kind = "btc_rvol_relief_5_20"
