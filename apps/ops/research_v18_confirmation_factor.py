"""Open the frozen v18 VXN holdout and export its point-in-time factor."""
...
from apps.ops.research_v18_snapshot import parse_and_audit_csv, verify_snapshot

SCHEMA_VERSION = "research.v18.confirmation_data.v1"
...
def request_plan() -> dict[str, Any]:
    ...
    return {
        "schema_version": "research.v18.confirmation_factor_plan.v1",
...
def write_confirmation_factor(
    ...
    *,
    ...
    if warmup_rows < 5:
        raise ValueError("Protocol v18 confirmation warmup is insufficient")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/research-v18/confirmation/factors/vxn.csv"),
    )
