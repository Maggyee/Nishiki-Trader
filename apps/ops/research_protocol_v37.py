"""Contract definitions and validation for Phase 2 Alpha Research Protocol v37."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v37.json")
SCHEMA_VERSION = "research.protocol.v37.v1"
