"""Fetch and audit Cboe historical CSVs for Protocol v39 (LOVOL, PUTD, CNDR)."""
...
from apps.ops.research_protocol_v39 import load_and_validate

SCHEMA_VERSION = "research.v39.snapshot.v1"
AUDIT_SCHEMA_VERSION = "research.v39.provider_qualification.v1"
RAW_ROOT = Path("data/research-v39/raw")
FACTORS_ROOT = Path("data/research-v39/factors")
QUALIFICATION_PATH = Path("docs/progress/phase-2-research-v39-provider-qualification.json")
DATA_SOURCES_PATH = Path("docs/progress/phase-2-research-v39-data-sources.json")

URLS = {
    "lovol": "https://cdn.cboe.com/api/global/us_indices/daily_prices/LOVOL_History.csv",
...
def _fetch(url: str) -> bytes:
    request = urllib.request.Request(
        url,
        headers={"User-Agent": "Nishiki-Trader/research-v39 (+https://github.com/Maggyee/Nishiki-Trader)"},
    )
...
def collect_and_qualify_all(
    ...
    qualification = {
        "schema_version": "research.provider_qualification.v39.v1",
        "protocol": "docs/progress/phase-2-research-protocol-v39.json",
