"""Contract definitions and validation for Phase 2 Alpha Research Protocol v46."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v46.json")
SCHEMA_VERSION = "research.protocol.v46.v1"
