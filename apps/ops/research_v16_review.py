"""Apply the frozen Protocol v16 gates to duplicate development bundles."""
...
from apps.ops.research_protocol_v16 import IDENTITIES, load_and_validate
from apps.ops.research_v13_review import (
    _classification as _classification,
)
from apps.ops.research_v13_review import (
    build_standard_review,
)

SCHEMA_VERSION = "research.v16.development_results.v1"
