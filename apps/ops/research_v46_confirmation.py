"""Contract validation for Protocol v46 confirmation holdout."""
...
DEFAULT_CONFIRMATION_PATH = Path("docs/progress/phase-2-research-v46-confirmation.json")
SCHEMA_VERSION = "research.v46.confirmation.v1"
...
def validate_confirmation_protocol(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if candidate.get("key") != "btc_prem_diff5_negative":
