"""Contract definitions and validation for Phase 2 Alpha Research Protocol v44."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v44.json")
SCHEMA_VERSION = "research.protocol.v44.v1"
