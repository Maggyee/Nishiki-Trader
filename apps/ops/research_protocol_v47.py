"""Contract definitions and validation for Phase 2 Alpha Research Protocol v47."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v47.json")
SCHEMA_VERSION = "research.protocol.v47.v1"
