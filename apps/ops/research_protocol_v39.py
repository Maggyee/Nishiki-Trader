"""Contract definitions and validation for Phase 2 Alpha Research Protocol v39."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v39.json")
SCHEMA_VERSION = "research.protocol.v39.v1"

INDEX_BY_CANDIDATE = {
    "lovol_expansion": "LOVOL",
    "putd_expansion": "PUTD",
    "cndr_expansion": "CNDR",
}
