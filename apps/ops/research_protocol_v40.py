"""Contract definitions and validation for Phase 2 Alpha Research Protocol v40."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v40.json")
SCHEMA_VERSION = "research.protocol.v40.v1"
