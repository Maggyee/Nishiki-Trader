"""Contract validation for Protocol v47 confirmation holdout."""
...
DEFAULT_CONFIRMATION_PATH = Path("docs/progress/phase-2-research-v47-confirmation.json")
SCHEMA_VERSION = "research.v47.confirmation.v1"
...
def validate_confirmation_protocol(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if candidate.get("key") != "btc_rvol_relief_5_20":
