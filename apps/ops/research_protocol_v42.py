"""Contract definitions and validation for Phase 2 Alpha Research Protocol v42."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v42.json")
SCHEMA_VERSION = "research.protocol.v42.v1"
