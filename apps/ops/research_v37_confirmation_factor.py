"""Extract the frozen 2023-2025 confirmation factor CSV for Protocol v37 without network access."""
...
from apps.ops.research_v37_snapshot import parse_and_audit_csv, verify_snapshot
...
def extract_confirmation_factor(
    ...
    data_sources_payload = {
        "schema_version": "research.v37.confirmation.data_sources.v1",
