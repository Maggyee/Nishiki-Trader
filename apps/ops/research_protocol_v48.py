"""Contract definitions and validation for Phase 2 Alpha Research Protocol v48."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v48.json")
SCHEMA_VERSION = "research.protocol.v48.v1"
