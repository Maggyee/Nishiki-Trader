"""Contract definitions and validation for Phase 2 Alpha Research Protocol v41."""
...
DEFAULT_PROTOCOL_PATH = Path("docs/progress/phase-2-research-protocol-v41.json")
SCHEMA_VERSION = "research.protocol.v41.v1"
