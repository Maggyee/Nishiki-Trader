"""Generate SignalEvent v1 signals for Protocol v47 (Binance BTC Realized Volatility Relief)."""
...
from apps.ops.research_protocol_v47 import IDENTITIES, PARAMETERS, SCHEMA_VERSION
            ...
            SignalEvent.model_validate(
                {
                    ...
                    "metadata": {
                        ...
                        "point_in_time_interpretation": "binance_spot_closed_daily_bars_lagged_1_calendar_day",
