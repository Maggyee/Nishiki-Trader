"""Generate SignalEvent v1 signals for Protocol v48 (Binance Perpetual Basis Moving-Average Relief)."""
...
from apps.ops.research_protocol_v48 import IDENTITIES, PARAMETERS, SCHEMA_VERSION
            ...
            SignalEvent.model_validate(
                {
                    ...
                    "metadata": {
                        ...
                        "point_in_time_interpretation": "binance_vision_basis_closed_daily_bars_lagged_1_calendar_day",
