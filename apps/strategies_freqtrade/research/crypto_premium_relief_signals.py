"""Generate SignalEvent v1 signals for Protocol v45 (Binance Perpetual Premium Index Relief)."""
...
from apps.ops.research_protocol_v45 import IDENTITIES, PARAMETERS, SCHEMA_VERSION
...
def generate_premium_relief_signals(
