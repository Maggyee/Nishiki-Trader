"""SignalEvent generators for Protocol v17 Cboe geographic/style volatility."""
...
from apps.ops.research_protocol_v17 import IDENTITIES, PARAMETERS
...
PROTOCOL_VERSION = "research.protocol.v17"
...
class VolatilityReliefParams:
    ...
    def __post_init__(self) -> None:
        if asdict(self) != PARAMETERS:
            raise ValueError("Protocol v17 volatility-relief parameters cannot be tuned")
...
def generate_geographic_vol_signals(
    ...
    *,
    ...
    if strategy not in STRATEGY_IDENTITIES:
        raise ValueError(f"unsupported Protocol v17 strategy {strategy!r}")
