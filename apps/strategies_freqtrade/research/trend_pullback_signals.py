"""Generate SignalEvent v1 signals for Protocol v44 (Trend & Oversold Pullback)."""
...
from apps.ops.research_protocol_v44 import IDENTITIES, PARAMETERS, SCHEMA_VERSION
...
def main(argv: list[str] | None = None) -> int:
    ...
    events = generate_trend_pullback_signals(
